...
public class VehicleDetailsActivity extends AppCompatActivity {
    ...
    private void analyseTemperatureData() {
        ...
        tempLineChart.animation(true); // Setting Animation for the chart tempLineChart.padding(10d, 20d, 5d, 20d);
        ...
        tempLineChart.crosshair().yLabel(true);
        ...
        //Map for mapping values in X-Axis (time) with Y-axix (temperature)
